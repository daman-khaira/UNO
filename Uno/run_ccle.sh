...
#python uno_baseline_keras2.py --train_sources CCLE --cache ./data_dir/cache --use_landmark_genes True --preprocess_rnaseq source_scale --no_feature_source True --no_response_source True -z $bsz --export_data ./data_dir/CCLE.h5 --export_tfrecords CCLE_TFR --cp True --shuffle True --on_memory_loader False
